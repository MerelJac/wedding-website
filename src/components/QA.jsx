...
export default function QA() {
  ...
  return (
    <div className="flex bg-white shadow-lg px-10 py-12  min-h-[60vh] items-center flex-col md:flex-row min-h-[60vh]">
      ...
      <div className="bg-white text-black p-6">{tabContent[activeTab]}</div>
    </div>
  );
}
